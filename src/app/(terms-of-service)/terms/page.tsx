    ...
    return (
        <div className="max-w-3xl mx-auto px-4 py-12 space-y-8 text-gray-800 leading-relaxed">
            ...
            <section>
                ...
                <p>
                    이 약관은 staylinker(스테이링커)(이하 "회사")가 제공하는 staylinker 인터넷 서비스 및 모바일
                    애플리케이션(이하 "서비스")에서 제공하는 매물 정보 제공, 중개 플랫폼, 커뮤니티 운영 등 서비스의
            ...
            <section>
                ...
                <p>
                    "서비스"란 회사가 제공하는 부동산 및 중고거래 매물 등록, 검색, 문의, 커뮤니티 운영 등 인터넷 및
                    모바일 애플리케이션을 통해 제공되는 모든 서비스를 말합니다.
                    <br />
                    "회원"이란 회사의 서비스에 접속하여 본 약관에 따라 이용계약을 체결하고, 아이디(ID)를 부여받아 회사가
                    제공하는 서비스를 이용하는 자로서, 일반회원(소비자)과 사업자회원으로 구분됩니다.
                    <br />
                    "일반회원"이라 함은 회사가 정한 절차에 따라 회원가입을 한 개인 이용자로서 매물 정보를 검색,
                    열람하거나 커뮤니티를 이용할 수 있는 자를 말합니다.
                    <br />
                    "사업자회원"이라 함은 중개업자, 통신판매업자 등 사업자로서 회사가 정한 절차에 따라 회원 가입을 마친
                    자를 말하며, 매물 등록 등의 활동이 가능합니다.
                    <br />
                    "매물"이란 사업자회원이 등록한 부동산 또는 중고거래 대상의 정보로서, 위치정보, 가격, 상세설명 등을
                    포함합니다.
                    <br />
                    "게시물"이란 회원이 서비스 내에 게시한 텍스트, 이미지, 파일 등 모든 정보를 말합니다.
                    <br />
                    "위치정보"란 특정 개인 또는 사물을 식별할 수 있는 위치에 관한 정보로, 매물의 위치 또는 회원의 현재
                    위치를 포함합니다.
                    <br />
