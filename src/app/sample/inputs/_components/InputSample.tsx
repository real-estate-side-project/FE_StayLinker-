    ...
    return (
        <div className="flex flex-row border-2 p-6 gap-10">
            <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-2">
                    <Input label="Label" icon={<FaReact />} placeholder="Input..." handleClickIcon={handleClickIcon} />
                ...
                <div className="flex gap-2">
                    <Input
                        ...
                        handleClickIcon={handleClickIcon}
                    />
                    <Input validationMessage="Supporting text.." icon={<FaReact />} isDisabled placeholder="Input..." />
                    <Input
                        validationMessage="Supporting text.."
                        icon={<FaReact />}
                        isError
