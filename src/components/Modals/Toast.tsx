...
const toastVariant = cva(
    'z-50 flex justify-start items-center gap-2 rounded-lg font-medium text-gray910 transition-all duration-500 p-4 mo:p-3 text-xl mo:text-base mt-2 border',
    {
        variants: {
            isOpen: {
